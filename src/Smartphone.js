...
const fixtures = [
    {
        id: 1,
        game: "Liscr vs NPA",
        time: "4:00 PM Dec. 22, 2022"
    },

    {
        id: 2,
        game: "LPRC Oilers vs Muscat FC",
    ...
    <div class="w-full max-w-sm p-4 bg-white border flex-1 shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700 flex-1">
        ...
        <div>
            <a href="#" class="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-gray-400">
                ...
                Still connected with us and get more information </a>
        </div>
    </div>
